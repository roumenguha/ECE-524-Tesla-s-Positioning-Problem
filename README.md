...
The code is contained in ZhouGuha.ipynb. You can view the code by installing Julia (this project was coded with Julia 0.5.1, so any version in the 0.5 series should work). You will need to have IJulia, Mosek and Gurobi licenses installed to run the code in Jupyter. Thankfully, Mosek and Gurobi offer free licenses for academic purposes.
